...
function Loader() {
  return <Html center className="text-white text-sm whitespace-nowrap">Loading Asset...</Html>;
}
...
class ModelErrorBoundary extends React.Component<{children: React.ReactNode}, {hasError: boolean}> {
  ...
  render() {
    if (this.state.hasError) {
      return (
        <Html center className="text-red-400 text-sm whitespace-nowrap bg-black/50 p-4 rounded-xl border border-red-500/50 backdrop-blur-md">
